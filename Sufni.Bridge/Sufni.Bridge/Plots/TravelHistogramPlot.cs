...
public class TravelHistogramPlot(Plot plot, SuspensionType type) : TelemetryPlot(plot)
{
    ...
    private void AddStatistics(TelemetryData telemetryData, double yRangeTop)
    {
        ...
        Plot.Add.VerticalLine(statistics.P99, 2f, StatColor, LinePattern.Dashed);
        ...
        AddSmallLabel("99th", statistics.P99, yRangeTop * 0.95, -8, 0, Alignment.MiddleRight);
        ...
        var statsText =
            ...
            $"99th:\u00A0{N(statistics.P99)}\u00A0mm\u00A0({N(p99Percentage, 4)}%)\n" +
