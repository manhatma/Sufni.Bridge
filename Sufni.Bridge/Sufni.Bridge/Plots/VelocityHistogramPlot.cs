...
public class VelocityHistogramPlot(Plot plot, SuspensionType type) : TelemetryPlot(plot)
{
    ...
    /// <summary>
    /// Stats box with avg/99th/max in mm/s — placed in the top padding area just below the title.
    /// </summary>
    private void AddStatsBox(TelemetryData telemetryData, double yRangeTop)
    {
        ...
        var p99Comp = compVels.Count > 0 ? compVels.Percentile(99) : 0.0;
        var p99Reb  = rebVels.Count  > 0 ? rebVels.Percentile(99)  : 0.0;
