...
internal static class SessionPlotCatalog
{
    ...
    [
        ...
        new(
            "frontVelHistPower", PlotGroup.Front, Front,
            _ => new VelocityHistogramPlot(new Plot(), SuspensionType.Front, powerWeighted: true),
            context => context.Data,
            PlotSize.Standard,
            (cache, svg) => cache.FrontVelocityHistogramPower = svg,
            cache => cache.FrontVelocityHistogramPower,
            (viewModel, image) => viewModel.DamperPage.FrontVelocityHistogramPower = image),
        new(
            "frontVelHistPowerLog", PlotGroup.Front, Front,
            _ => new VelocityHistogramPlot(new Plot(), SuspensionType.Front, powerWeighted: true, powerLogY: true),
            context => context.Data,
            PlotSize.Standard,
            (cache, svg) => cache.FrontVelocityHistogramPowerLog = svg,
            cache => cache.FrontVelocityHistogramPowerLog,
            (viewModel, image) => viewModel.DamperPage.FrontVelocityHistogramPowerLog = image),
        new(
        ...
        new(
            "frontLsVelHistLog", PlotGroup.Front, Front,
            _ => new LowSpeedVelocityHistogramPlot(new Plot(), SuspensionType.Front, 200, logScale: true),
            context => context.Data,
            PlotSize.LessBandView,
            (cache, svg) => cache.FrontLowSpeedVelocityHistogramLog = svg,
            cache => cache.FrontLowSpeedVelocityHistogramLog,
            (viewModel, image) => viewModel.DamperPage.FrontLowSpeedVelocityHistogramLog = image),
        new(
        ...
        new(
            "rearVelHistPower", PlotGroup.Rear, Rear,
            _ => new VelocityHistogramPlot(new Plot(), SuspensionType.Rear, powerWeighted: true),
            context => context.Data,
            PlotSize.Standard,
            (cache, svg) => cache.RearVelocityHistogramPower = svg,
            cache => cache.RearVelocityHistogramPower,
            (viewModel, image) => viewModel.DamperPage.RearVelocityHistogramPower = image),
        new(
            "rearVelHistPowerLog", PlotGroup.Rear, Rear,
            _ => new VelocityHistogramPlot(new Plot(), SuspensionType.Rear, powerWeighted: true, powerLogY: true),
            context => context.Data,
            PlotSize.Standard,
            (cache, svg) => cache.RearVelocityHistogramPowerLog = svg,
            cache => cache.RearVelocityHistogramPowerLog,
            (viewModel, image) => viewModel.DamperPage.RearVelocityHistogramPowerLog = image),
        new(
        ...
        new(
            "rearDamperVelHistPower", PlotGroup.Rear, Rear,
            _ => new DamperVelocityHistogramPlot(new Plot(), powerWeighted: true),
            context => context.Data,
            PlotSize.Standard,
            (cache, svg) => cache.RearDamperVelocityHistogramPower = svg,
            cache => cache.RearDamperVelocityHistogramPower,
            (viewModel, image) => viewModel.DamperPage.RearDamperVelocityHistogramPower = image),
        new(
            "rearDamperVelHistPowerLog", PlotGroup.Rear, Rear,
            _ => new DamperVelocityHistogramPlot(new Plot(), powerWeighted: true, powerLogY: true),
            context => context.Data,
            PlotSize.Standard,
            (cache, svg) => cache.RearDamperVelocityHistogramPowerLog = svg,
            cache => cache.RearDamperVelocityHistogramPowerLog,
            (viewModel, image) => viewModel.DamperPage.RearDamperVelocityHistogramPowerLog = image),
        new(
        ...
        new(
            "rearLsVelHistLog", PlotGroup.Rear, Rear,
            _ => new LowSpeedVelocityHistogramPlot(new Plot(), SuspensionType.Rear, 200, logScale: true),
            context => context.Data,
            PlotSize.LessBandView,
            (cache, svg) => cache.RearLowSpeedVelocityHistogramLog = svg,
            cache => cache.RearLowSpeedVelocityHistogramLog,
            (viewModel, image) => viewModel.DamperPage.RearLowSpeedVelocityHistogramLog = image),
        new(
